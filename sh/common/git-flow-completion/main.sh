...
if [[ -e /home/$DOTFILE_DEFAULT_USER/.git-flow-completion ]]; then
    ...
    chmod $DOTFILE_DEFAULT_USER:$DOTFILE_DEFAULT_USER /home/$DOTFILE_DEFAULT_USER/.git-flow-completion
    echo -e "source ~/git-flow-completion.bash" >> /home/$DOTFILE_DEFAULT_USER/.bashrc
