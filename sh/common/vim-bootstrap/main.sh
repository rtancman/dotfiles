...
if [[ -e /home/$DOTFILE_DEFAULT_USER/.vimrc ]]; then
    ...
    curl -X POST -d 'langs=c&langs=elixir&langs=elm&langs=erlang&langs=go&langs=html&langs=javascript&langs=php&langs=python&langs=ruby&langs=scala&langs=typescript&langs=rust&editor=vim' https://vim-bootstrap.com/generate.vim >> /home/$DOTFILE_DEFAULT_USER/.vimrc
    chown $DOTFILE_DEFAULT_USER:$DOTFILE_DEFAULT_USER /home/$DOTFILE_DEFAULT_USER/.vimrc;
