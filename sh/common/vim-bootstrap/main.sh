...
if [[ -e /home/$DOTFILE_DEFAULT_USER/.vimrc ]]; then
    ...
    su - $DOTFILE_DEFAULT_USER curl -X POST -d 'langs=c&langs=elixir&langs=elm&langs=erlang&langs=go&langs=html&langs=javascript&langs=php&langs=python&langs=ruby&editor=vim' https://vim-bootstrap.com/generate.vim >> /home/$DOTFILE_DEFAULT_USER/.vimrc
